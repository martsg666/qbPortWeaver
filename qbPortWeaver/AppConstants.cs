...
public static class AppConstants
{
    ...
    /// <para><b>A deliberate exception to this file's constants-only rule</b>, and the only method
    /// here. That rule exists to stop <i>behaviour with dependencies</i> accumulating here - file I/O,
    /// service lookup, process control, theming - which is what the 2.6.7 split moved out. This is a pure
