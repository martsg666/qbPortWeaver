...
partial class SettingsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        chkPortClosedRecovery.Location       = new Point(28, 220);
        chkPortClosedRecovery.Name           = "chkPortClosedRecovery";
        chkPortClosedRecovery.Size           = new Size(250, 19);
        chkPortClosedRecovery.TabIndex       = 15;
        chkPortClosedRecovery.Text           = "Recover when the port stays closed";
        chkPortClosedRecovery.CheckedChanged += chkPortClosedRecovery_CheckedChanged;
        lblPortClosedCycles.Location  = new Point(44, 242);
        lblPortClosedCycles.Name      = "lblPortClosedCycles";
        lblPortClosedCycles.Size      = new Size(164, 23);
        lblPortClosedCycles.TabIndex  = 16;
        lblPortClosedCycles.Text      = "Trigger after";
        lblPortClosedCycles.TextAlign = ContentAlignment.MiddleLeft;
        nudPortClosedCycles.Location = new Point(212, 242);
        ...
        nudPortClosedCycles.TabIndex = 17;
        nudPortClosedCycles.Value    = new decimal(new int[] { 3, 0, 0, 0 });
        lblPortClosedCyclesUnit.Location  = new Point(266, 242);
        lblPortClosedCyclesUnit.Name      = "lblPortClosedCyclesUnit";
        lblPortClosedCyclesUnit.Size      = new Size(202, 23);
        lblPortClosedCyclesUnit.TabIndex  = 18;
        ...
        chkNotifyOnPortUpdate.Location  = new Point(12, 270);
        ...
        chkShowUpdateForm.Location      = new Point(12, 298);
