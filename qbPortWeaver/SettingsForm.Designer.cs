...
partial class SettingsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblPortClosedCycles.AutoSize  = true;
        lblPortClosedCycles.Location  = new Point(28, 285);
        lblPortClosedCycles.Name      = "lblPortClosedCycles";
        lblPortClosedCycles.TabIndex  = 15;
        lblPortClosedCycles.Text      = "Trigger after";
        lblPortClosedCycles.TextAlign = ContentAlignment.MiddleLeft;
        nudPortClosedCycles.Location = new Point(112, 285);
        ...
        nudPortClosedCycles.TabIndex = 16;
        nudPortClosedCycles.Value    = new decimal(new int[] { 3, 0, 0, 0 });
        lblPortClosedCyclesUnit.Location  = new Point(168, 285);
        lblPortClosedCyclesUnit.Name      = "lblPortClosedCyclesUnit";
        lblPortClosedCyclesUnit.Size      = new Size(270, 23);
        lblPortClosedCyclesUnit.TabIndex  = 17;
        ...
        nudDefaultPort.Location = new Point(148, 227);
