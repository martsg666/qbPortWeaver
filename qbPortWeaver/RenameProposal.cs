namespace qbPortWeaver
{
    ...
    /// <param name="MediaType">Short label used in the results grid, e.g. "Movie" or "TV".</param>
    ...
    public record RenameProposal(string MediaType, string OriginalPath, string ProposedPath, bool IsConfident = true, bool IsMatched = true);
}
